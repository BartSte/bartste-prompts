import unittest
from prompts.prompt import Prompt, Instructions
...
class TestPrompt(unittest.TestCase):
    ...
    def test_str_all_fields(self) -> None:
        ...
        prompt = Prompt(command='cmd', files='f', filetype='ft', userprompt='up')
...
class TestInstructionsGet(unittest.TestCase):
    ...
    def test_get_formats_placeholders(self) -> None:
        ...
        instr._read = lambda path: 'command={command}, filetype={filetype}, user={userprompt}'
